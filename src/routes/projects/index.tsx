...
function ProjectsOverviewPage() {
  ...
  const projectKeywords = Array.from(new Set(PROJECTS.flatMap((p) => p.techUsed))).slice(0, 10)

  return (
    <>
      <SEOHead
        title='Projects Portfolio'
        description='Explore my software engineering projects including full-stack web applications, React components, and modern development tools. Built with React, TypeScript, Next.js, and more.'
        keywords={['software projects', 'full stack developer', 'web applications', 'portfolio', ...projectKeywords]}
        url='/projects'
        type='website'
      />
            ...
            <div className='flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6'>
              <div>
                ...
                <p className='text-lg text-muted-foreground max-w-2xl'>
                  A showcase of my technical journey - from concept to deployment. Each project represents my passion
                  for learning new technologies and building products that just make sense.
                </p>
              </div>
              <Tooltip>
