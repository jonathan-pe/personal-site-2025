...
function RouteComponent() {
  ...
  const projectStructuredData = {
    ...
    url: project.url || `https://www.jonathanpe.com/projects/${project.id}`,
    author: {
      '@type': 'Person',
      name: 'Jonathan Pe',
    },
  ...
  return (
    <>
      <SEOHead
        ...
        description={`${project.description} Built with ${project.techUsed.slice(0, 3).join(', ')}${
          project.techUsed.length > 3 ? ' and more' : ''
        }.`}
        keywords={[
